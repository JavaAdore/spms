...
public class ProjectDAOImpl implements ProjectDAO  {
	...
	public List<JoinProjectRequest> loadJoinReqeusts(Supervisor supervisor) {
		Query query = em.createQuery("select model from JoinProjectRequest model where model.project.supervisor =:supervisor ");
	...
	public void delete(JoinProjectRequest joinProjectRequest) {
		...
		Query query = em.createQuery("delete from JoinProjectRequest where id =:id");
